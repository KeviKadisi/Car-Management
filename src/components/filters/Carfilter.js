...
const modelFilter= modelRef.current.value;
  ...
  <div className={classes.filters} >
    <div className={classes.carfilter}>
      <select  ref={brandRef} name="brand" id="brand" onChange={brandFilterHandler}>
...
<div>
<select ref={yearRef} name="year" id="year" onChange={brandFilterHandler}>
  <option value="" defaultValue>
    Year
  </option>
...
<div>
<select ref={modelRef} name="model" id="model" onChange={brandFilterHandler}>
  <option value="" defaultValue>
    Model
  </option>
